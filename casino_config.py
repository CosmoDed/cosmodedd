...
tickets = '1900365950:AAH0Zni_1LYQJ-Ojbc_kskYQUDFD7PaZhuc' # TOKEN Бота воркера
bot = telebot.TeleBot('1951393815:AAG9w4aE92fTiGvVY7FaD5y1HNoa5tWORVw') # TOKEN Бота казино

admin = 478014217 # ID Админа
support_id = 677722622 # ID Саппорта
channel_id = -1001554518315 # ID Канала с вылатами
support = 'Dsdasrf' # Username Сапорта

phone = '79680840168' # Номер киви без +
...
def nvuti(message):
	try:
		...
		bot.send_message(message.chat.id, '⚠️ Пожалуйста, введите *число*', parse_mode="Markdown")
# @SCRIPTSLIV @SCRIPTSLIV @SCRIPTSLIV
# @SCRIPTSLIV @SCRIPTSLIV @SCRIPTSLIV
# @SCRIPTSLIV @SCRIPTSLIV @SCRIPTSLIV