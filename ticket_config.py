...
bot = telebot.TeleBot('1900365950:AAH0Zni_1LYQJ-Ojbc_kskYQUDFD7PaZhuc') # Токен бота воркеров

admin = 478014217 # ID Админа
support = 677722622 # ID сапорта
channel_id = -1001554518315 # ID Канала залётов
chat_worker_id = -532169224 # ID Чата с воркерами

bot_name = '@LeonBetTeam_bot' # Username Бота

mater = '' # Ссылка на мануалы
zalet = 'https://t.me/joinchat/RjVCB1oRmws5ZmNi' # Ссылка на канал с залётами
infos = '' # Ссылка на инфо канал
pname = 'LeonBet' # Название проекта
pdate = '12.09.2021' # Дата созданя проекта
